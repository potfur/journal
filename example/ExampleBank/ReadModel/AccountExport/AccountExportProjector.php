...
class AccountExportProjector implements EventSubscriberInterface
{
    /**
     * @var AccountExport[]
     */
    ...
    public function onAccountOpened(AccountOpenedEnvelope $event)
    {
        ...
        $this->accounts[(string) $event->getAccountNumber()] = new AccountExport(
    ...
    {
        $this->accounts[(string) $event->getAccountNumber()]->increaseBy(
            $event->getAmount(),
            $event->getTimestamp()
        );
    }
    ...
    {
        $this->accounts[(string) $event->getAccountNumber()]->decreaseBy(
            $event->getAmount(),
            $event->getTimestamp()
        );
    }
